...
/**
 * demoness - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelDemoness extends ModelBase {
	...
	public ModelDemoness() {
		...
		this.setRotateAngle(this.rWing04, -0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.hair02, 0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail02, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail03, 0.06981317007977318F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing04, -0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn04, 0.05235987755982988F, 0.0F, -0.13962634015954636F);
		...
		this.setRotateAngle(this.lHorn04, 0.05235987755982988F, 0.0F, 0.13962634015954636F);
		...
		this.setRotateAngle(this.bipedRightLeg, -0.2617993877991494F, 0.0F, 0.10471975511965977F);
		...
		this.setRotateAngle(this.tailTip02, 0.0F, 0.7853981633974483F, 0.0F);
		...
		this.setRotateAngle(this.loincloth02, 0.22689280275926282F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing02, 0.5235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn03a, -0.10471975511965977F, 0.0F, -0.10471975511965977F);
		...
		this.setRotateAngle(this.tail05, 0.22689280275926282F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn01, -0.17453292519943295F, -0.13962634015954636F, -0.13962634015954636F);
		...
		this.setRotateAngle(this.lHorn01, -0.17453292519943295F, 0.13962634015954636F, 0.13962634015954636F);
		...
		this.setRotateAngle(this.hair01, 0.20943951023931953F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn02a, -0.17453292519943295F, 0.0F, 0.05235987755982988F);
		...
		this.setRotateAngle(this.lWing03, 0.20943951023931953F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing03, 0.20943951023931953F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tailTip01, 0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail01, -0.8726646259971648F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWingMembrane, -0.091106186954104F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWingMembrane, -0.091106186954104F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing01, 0.27314402793711257F, 0.5235987755982988F, 0.0F);
		...
		this.setRotateAngle(this.lHorn05, 0.05235987755982988F, 0.0F, -0.13962634015954636F);
		...
		this.setRotateAngle(this.rWing02, 0.5235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail04, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedLeftLeg, -0.2617993877991494F, 0.0F, -0.10471975511965977F);
		...
		this.setRotateAngle(this.loincloth, -0.22689280275926282F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.boobs, -0.4886921905584123F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn05, 0.05235987755982988F, 0.0F, 0.13962634015954636F);
		...
		this.setRotateAngle(this.lHorn03a, -0.10471975511965977F, 0.0F, 0.10471975511965977F);
		...
		this.setRotateAngle(this.rHorn02a, -0.17453292519943295F, 0.0F, -0.05235987755982988F);
		...
		this.setRotateAngle(this.rWing01, 0.27314402793711257F, -0.5235987755982988F, 0.0F);
