...
public class ModelGirdleOfTheWooded extends ModelBase {
	...
	public ModelGirdleOfTheWooded() {
		...
		this.setRotateAngle(this.barkFront2c, -0.026075345208696685F, 0.43477582849948554F, 0.037526528018900884F);
		...
		this.setRotateAngle(this.barkBack2a, -3.1391492032896458F, 0.2609267198442009F, -3.1213467703507924F);
		...
		this.setRotateAngle(this.barkFront1b, 0.035444630965055866F, 0.1744255332284755F, 0.006153645656359201F);
		...
		this.setRotateAngle(this.barkBack1b, 0.035444551902461F, 0.1744255332284755F, 0.0061536955906296405F);
		...
		this.setRotateAngle(this.rootLeft2, 0.2617993877991494F, -0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.barkBack3b, -0.15734173766502388F, 0.42867029867388357F, -0.08382197165770001F);
		...
		this.setRotateAngle(this.barkFront2a, 0.0024434609631950343F, -0.2609267198442009F, -0.020245818740567734F);
		...
		this.setRotateAngle(this.barkFront3d, -0.42063677337711863F, 0.2867452177299217F, -0.334097154017912F);
		...
		this.setRotateAngle(this.barkFront2b, 0.17746230252997924F, 0.26099494670237733F, 0.020280113181386308F);
		...
		this.setRotateAngle(this.barkFront3c, 0.0035554643965062705F, 0.13856031006470126F, 0.5847116647128922F);
		...
		this.setRotateAngle(this.barkFront1c, -0.015215062708624117F, 0.3488441755276304F, 0.012701695067186129F);
		...
		this.setRotateAngle(this.rootRight1, 0.6108652381980153F, 0.2617993877991494F, 0.0F);
		...
		this.setRotateAngle(this.rootRight2, 0.2617993877991494F, 0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.barkBack1a, -3.087836480670435F, 0.1738347941644255F, -3.126233670951088F);
		...
		this.setRotateAngle(this.barkFront3a, 0.26424285474405396F, -0.2609267198442009F, -0.020245818740567734F);
		...
		this.setRotateAngle(this.rootRight3, 0.5235987755982988F, 0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.barkBack3a, -2.877349815490496F, 0.2609267198442009F, -3.1213467703507924F);
		...
		this.setRotateAngle(this.barkBack2c, -0.026075313999777656F, 0.43477582849948554F, 0.037526698627658214F);
		...
		this.setRotateAngle(this.barkBack1c, -0.01521546530367953F, 0.3488441755276304F, 0.012701799096916213F);
		...
		this.setRotateAngle(this.barkFront1a, 0.0537561396298448F, -0.1738347941644255F, -0.015358897334326315F);
		...
		this.setRotateAngle(this.rootLeft1, 0.6108652381980153F, -0.2617993877991494F, 0.0F);
		...
		this.setRotateAngle(this.barkBack2b, 0.17746230252997924F, 0.26099494670237733F, 0.02028021929171099F);
		...
		this.setRotateAngle(this.barkBack3d, -0.1668814470057967F, 0.3618904690757106F, -0.3709979806610772F);
		...
		this.setRotateAngle(this.barkBack3c, -0.15854242384248612F, 0.33488954431075146F, 0.32152516945997495F);
		...
		this.setRotateAngle(this.barkFront3b, -0.15734130490134676F, 0.4286702320948563F, -0.08382216307240337F);
		...
		this.setRotateAngle(this.rootLeft3, 0.5235987755982988F, -0.3490658503988659F, 0.0F);
	...
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float rotationYaw, float rotationPitch, float f5) {
		...
		if (barkPieces > 0) {
			this.barkBack1a.render(1);
			this.barkFront1a.render(1);
		}

		if (barkPieces > 1) {
			this.barkFront2a.render(1);
			this.barkBack2a.render(1);
		}

		if (barkPieces > 2) {
			this.barkFront3a.render(1);
			this.barkBack3a.render(1);
		}

		if (barkPieces > 3) {
			this.rootRight1.render(1);
			this.rootLeft1.render(1);
			this.rootRight3.render(1);
			this.rootLeft3.render(1);
		}
	}
