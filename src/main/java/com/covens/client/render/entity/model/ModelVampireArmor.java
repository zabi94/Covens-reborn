...
/**
 * Vampire's attire - Ingoleth Created using Tabula 5.1.0
 */
public class ModelVampireArmor extends ModelBiped {
	...
	public ModelVampireArmor() {
		...
		this.setRotateAngle(this.capeRightFront_1, -0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeCollarBack1, -0.4363323129985824F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeLeftSide_1, 0.0F, 0.0F, 0.19198621771937624F);
		...
		this.setRotateAngle(this.capeBackLeft1, -0.05235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeRightSide, 0.0F, 0.06981317007977318F, -0.06108652381F);
		...
		this.setRotateAngle(this.capeBackLeft, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeCollarRight2, 0.0F, 0.0F, 0.4363323129985824F);
		...
		this.setRotateAngle(this.capeLeftFront_1, -0.17453292519943295F, 0.0F, 0.0F);
		this.tie = new ModelRenderer(this, 28, 37);
		this.tie.setRotationPoint(-1.5F, 0.0F, -3.0F);
		this.tie.addBox(0.0F, 0.0F, 0.0F, 3, 3, 1, 0.0F);
		this.setRotateAngle(this.tie, 0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeBack2, 0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeRightSide_1, 0.0F, 0.0F, -0.19198621771937624F);
		...
		this.setRotateAngle(this.capeBackRight2, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeLeftSide, 0.0F, -0.06981317007977318F, 0.06108652381F);
		...
		this.bipedBody.addChild(this.capeCollarBack1);
		this.bipedBody.addChild(this.capeCollarLeft1);
		this.bipedBody.addChild(this.capeCollarRight1);
		this.bipedLeftArm.addChild(this.armLeft);
		this.bipedRightArm.addChild(this.armRight);
		this.bipedBody.addChild(this.capeBack1);
		this.bipedHead.addChild(this.hatAnchor);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		if (entityIn instanceof EntityArmorStand) {
			...
			this.capeBack1.rotateAngleX = 0.08726646259971647F + limbSwingAmount;
			this.capeLeftFront.rotateAngleY = limbSwingAmount * 1.5F;
			this.capeRightFront.rotateAngleY = -this.capeLeftFront.rotateAngleY;
