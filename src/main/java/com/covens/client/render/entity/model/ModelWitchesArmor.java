...
/**
 * Witches_attire - Ingoleth Created using Tabula 5.1.0
 */
public class ModelWitchesArmor extends ModelBiped {
	...
	public ModelWitchesArmor() {
		...
		ModelHelper.setRotateAngle(this.tunicRightBack_1, 0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicFront, 0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicRightFront_1, -0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicLeft, 0.12217304763960307F, -1.5707963267948966F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicLeftFront, -3.01941960595019F, 0.0F, 3.141592653589793F);
		...
		ModelHelper.setRotateAngle(this.tunicLeft_1, 0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicRightFront, -0.12217304763960307F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.hat2, -0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicRight_1, -0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.sleeveRight, 0.5235987755982988F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.hatWing, 0.03490658503988659F, 0.0F, 0.06981317007977318F);
		...
		ModelHelper.setRotateAngle(this.tunicRight, -0.12217304763960307F, -1.5707963267948966F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicLeftBack, 3.01941960595019F, 0.0F, 3.141592653589793F);
		...
		ModelHelper.setRotateAngle(this.hat3, -0.3490658503988659F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicLeftBack_1, -0.2617993877991494F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.tunicRightBack, 0.12217304763960307F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(this.sleeveLeft, 0.5235987755982988F, 0.0F, 0.0F);
