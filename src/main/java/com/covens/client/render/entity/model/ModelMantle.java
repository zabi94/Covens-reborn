...
public class ModelMantle extends ModelBiped {
	...
	public ModelMantle(ModelPlayer model) {
		...
		this.setRotateAngle(this.hoodLeft2, 0.0F, 3.141592653589793F, 0.12217304763960307F);
		...
		this.setRotateAngle(this.hoodTop1, 3.141592653589793F, 0.0F, -3.01941960595019F);
		...
		this.setRotateAngle(this.CapeRightFront2, -0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.hoodBack, 0.15707963267948966F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.CapeLeftFront2, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.hoodRight2, 0.0F, 0.0F, -0.12217304763960307F);
		...
		this.setRotateAngle(this.hoodRight1, 0.12217304763960307F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.capeRight2, 0.03490658503988659F, 1.5707963267948966F, 0.06108652381F);
		...
		this.setRotateAngle(this.hoodTop2, 0.0F, 3.141592653589793F, -0.12217304763960307F);
		...
		this.setRotateAngle(this.hoodLeft1, 0.0F, 3.141592653589793F, 0.0F);
		...
		this.setRotateAngle(this.capeLeft2, -0.03490658503988659F, -1.5707963267948966F, 0.06108652381F);
		...
		this.setRotateAngle(this.neck, 1.3089969389957472F, 0.0F, 0.0F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		if (limbSwingAmount > 0.05) {
			...
			this.armRight.rotateAngleX = (-0.52359877559F / 0.333333F) * limbSwingAmount;
			this.armLeft.rotateAngleX = this.armRight.rotateAngleX;
			this.armRight.offsetY = -limbSwingAmount;
			this.armLeft.offsetY = -limbSwingAmount;
		} else {
