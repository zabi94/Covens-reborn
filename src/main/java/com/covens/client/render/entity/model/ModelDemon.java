...
/**
 * demon - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelDemon extends ModelBase {
	...
	public ModelDemon() {
		...
		this.setRotateAngle(this.rHorn01, 0.10471975511965977F, 0.0F, -0.41887902047863906F);
		...
		this.setRotateAngle(this.lHorn02, -0.10471975511965977F, 0.0F, -0.19198621771937624F);
		...
		this.setRotateAngle(this.rHorn04, -0.13962634015954636F, 0.0F, 0.10471975511965977F);
		...
		this.setRotateAngle(this.rHorn03a, -0.13962634015954636F, 0.0F, 0.06981317007977318F);
		this.lHoof = new ModelRenderer(this, 0, 53);
		...
		this.bipedLeftLeg.addBox(-2.0F, 0.0F, -2.5F, 4, 7, 5, 0.0F);
		this.setRotateAngle(this.bipedLeftLeg, -0.2617993877991494F, 0.0F, -0.10471975511965977F);
		this.rHoof = new ModelRenderer(this, 0, 53);
		...
		this.setRotateAngle(this.lHorn03a, -0.13962634015954636F, 0.0F, -0.06981317007977318F);
		...
		this.bipedRightLeg.addBox(-2.0F, 0.0F, -2.5F, 4, 7, 5, 0.0F);
		...
		this.setRotateAngle(this.lHorn01, 0.10471975511965977F, 0.0F, 0.41887902047863906F);
		...
		this.setRotateAngle(this.lHorn04, -0.13962634015954636F, 0.0F, -0.10471975511965977F);
		...
		this.setRotateAngle(this.rHorn02, -0.10471975511965977F, 0.0F, 0.19198621771937624F);
