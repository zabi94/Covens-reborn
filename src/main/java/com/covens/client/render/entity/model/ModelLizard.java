...
/**
 * lizard - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelLizard extends ModelBase {
	...
	public ModelLizard() {
		...
		this.setRotateAngle(this.rArm01, 0.06981317007977318F, 0.3490658503988659F, -0.2792526803190927F);
		...
		this.setRotateAngle(this.tail03, 0.05235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.body01, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lLeg01, 0.03490658503988659F, 0.6108652381980153F, 0.0F);
		...
		this.setRotateAngle(this.rBToes, -0.017453292519943295F, 0.0F, 0.0F);
		this.neck = new ModelRenderer(this, 29, 0);
		this.neck.setRotationPoint(0.0F, -0.7F, -7.7F);
		this.neck.addBox(-2.0F, -2.0F, -2.6F, 4, 4, 3, 0.0F);
		this.setRotateAngle(this.neck, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lEye, 0.0F, 0.12217304763960307F, -0.19198621771937624F);
		...
		this.setRotateAngle(this.rEye, 0.0F, -0.12217304763960307F, 0.19198621771937624F);
		...
		this.setRotateAngle(this.snoutb, 0.08726646259971647F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail05, 0.08726646259971647F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.body02, 0.10471975511965977F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rArm02, -0.17453292519943295F, 0.0F, 0.2617993877991494F);
		...
		this.setRotateAngle(this.snout, 0.08726646259971647F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lFToes01, 0.05235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lowerJaw, -0.15707963267948966F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail01, -0.08726646259971647F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rLeg02, 0.3665191429188092F, 0.0F, 0.20943951023931953F);
		...
		this.setRotateAngle(this.head, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lFoot, -0.3490658503988659F, -0.6806784082777886F, 0.45378560551852565F);
		...
		this.setRotateAngle(this.rFoot, -0.3490658503988659F, 0.6806784082777886F, -0.45378560551852565F);
		...
		this.setRotateAngle(this.lForeFoot, 0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rFToes01, 0.05235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lLeg02, 0.3665191429188092F, 0.0F, -0.20943951023931953F);
		...
		this.setRotateAngle(this.rLeg01, 0.03490658503988659F, -0.6108652381980153F, 0.0F);
		...
		this.setRotateAngle(this.lArm02, -0.17453292519943295F, 0.0F, -0.2617993877991494F);
		...
		this.setRotateAngle(this.lArm01, 0.06981317007977318F, -0.3490658503988659F, 0.2792526803190927F);
		...
		this.setRotateAngle(this.tail02, -0.08726646259971647F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rForeFoot, 0.17453292519943295F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail04, 0.08726646259971647F, 0.0F, 0.0F);
