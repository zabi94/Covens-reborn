...
/**
 * leonard3 - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelMasterLeonard extends ModelBase {
	...
	public ModelMasterLeonard() {
		...
		this.setRotateAngle(this.lClaw03, 0.13962634015954636F, 0.3141592653589793F, 0.0F);
		...
		this.setRotateAngle(this.mHorn02, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedRightArm, 0.0F, 0.0F, 0.10000736613927509F);
		...
		this.setRotateAngle(this.lWebbing02, 0.13962634015954636F, 0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.muzzleLower, 0.06981317007977318F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.chestFur02, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn04, 0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.mHorn04, 0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn03a, -0.3141592653589793F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedRightLeg, -0.10471975511965977F, 0.0F, 0.06981317007977318F);
		...
		this.setRotateAngle(this.rClaw01, 0.13962634015954636F, 0.3141592653589793F, 0.0F);
		...
		this.setRotateAngle(this.lWebbing01, 0.13962634015954636F, -0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.rClaw03, 0.13962634015954636F, -0.3141592653589793F, 0.0F);
		...
		this.setRotateAngle(this.rLeg02, 0.17453292519943295F, 0.0F, -0.06981317007977318F);
		...
		this.setRotateAngle(this.lClaw01, 0.13962634015954636F, -0.3141592653589793F, 0.0F);
		...
		this.setRotateAngle(this.rHorn01, -0.5235987755982988F, 0.0F, -0.5235987755982988F);
		...
		this.setRotateAngle(this.muzzleUpper, 0.06981317007977318F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWebbing01, 0.13962634015954636F, 0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.mHorn01, -0.9599310885968813F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn03a, -0.3141592653589793F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rToes, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.muzzleUpper02, 0.06981317007977318F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn04, 0.2617993877991494F, 0.0F, 0.0F);
		this.bipedLeftLeg = new ModelRenderer(this, 0, 16);
		this.bipedLeftLeg.setRotationPoint(1.9F, 9.2F, 0.1F);
		this.bipedLeftLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 8, 4, 0.0F);
		this.setRotateAngle(this.bipedLeftLeg, -0.10471975511965977F, 0.0F, -0.06981317007977318F);
		...
		this.setRotateAngle(this.lLeg02, 0.17453292519943295F, 0.0F, 0.06981317007977318F);
		...
		this.setRotateAngle(this.mHorn03a, -0.3141592653589793F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.chestFur01, -0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lClaw02, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lFoot, -0.06981317007977318F, -0.05235987755982988F, 0.0F);
		this.lEar = new ModelRenderer(this, 40, 0);
		this.lEar.setRotationPoint(2.6F, -4.3F, 0.0F);
		this.lEar.addBox(0.0F, -0.5F, -1.0F, 4, 1, 2, 0.0F);
		this.setRotateAngle(this.lEar, -0.5235987755982988F, 0.0F, 0.3141592653589793F);
		...
		this.setRotateAngle(this.rEar, -0.5235987755982988F, 0.0F, -0.3141592653589793F);
		...
		this.setRotateAngle(this.rHorn02, -0.13962634015954636F, 0.0F, -0.20943951023931953F);
		...
		this.setRotateAngle(this.lToes, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.beard, -0.10471975511965977F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn01, -0.5235987755982988F, 0.0F, 0.5235987755982988F);
		...
		this.setRotateAngle(this.rFoot, -0.06981317007977318F, 0.05235987755982988F, 0.0F);
		...
		this.setRotateAngle(this.rClaw02, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn02, -0.13962634015954636F, 0.0F, 0.20943951023931953F);
		...
		this.setRotateAngle(this.rWebbing02, 0.13962634015954636F, -0.3490658503988659F, 0.0F);
