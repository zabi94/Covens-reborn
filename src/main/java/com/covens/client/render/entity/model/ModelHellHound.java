...
/**
 * hellhoundALT - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelHellHound extends ModelBase {
	...
	public ModelHellHound() {
		...
		this.setRotateAngle(this.rHorn01, -1.0016444577195458F, -0.4553564018453205F, 0.0F);
		...
		this.setRotateAngle(this.lHorn02, -0.6108652381980153F, 0.17453292519943295F, 0.0F);
		...
		this.setRotateAngle(this.tailThin01, -1.0471975511965976F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn06, -0.6283185307179586F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tailThin03, 0.20943951023931953F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn05a, -0.6981317007977318F, 0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.rHorn03a, -0.6981317007977318F, -0.20943951023931953F, 0.0F);
		...
		this.setRotateAngle(this.lHorn03a, -0.6981317007977318F, 0.20943951023931953F, 0.0F);
		...
		this.setRotateAngle(this.rHorn04a, -0.6981317007977318F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn01, -1.0016444577195458F, 0.4553564018453205F, 0.0F);
		...
		this.setRotateAngle(this.tailThin05, 0.0F, 0.0F, 0.7853981633974483F);
		...
		this.setRotateAngle(this.tailThin02, 0.27314402793711257F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.neck, -1.5707963267948966F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn02, -0.6108652381980153F, -0.17453292519943295F, 0.0F);
		...
		this.setRotateAngle(this.rHorn06, -0.6283185307179586F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.mane02, -1.2915436464758039F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn05a, -0.6981317007977318F, -0.3490658503988659F, 0.0F);
		...
		this.setRotateAngle(this.mane01, 0.4363323129985824F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn04a, -0.6981317007977318F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tailThin04, 0.20943951023931953F, 0.0F, 0.0F);
