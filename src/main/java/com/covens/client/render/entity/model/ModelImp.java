...
/**
 * imp - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelImp extends ModelBase {
	...
	public ModelImp() {
		...
		this.setRotateAngle(this.rWing03, 0.6283185307179586F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing04, 0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail04, 0.2792526803190927F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lLegFur, -0.10471975511965977F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn02, -0.13962634015954636F, 0.0F, -0.10471975511965977F);
		...
		this.setRotateAngle(this.rLeg03, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tailFur02L, 0.0F, 0.12217304763960307F, 0.0F);
		...
		this.setRotateAngle(this.rEar01, -0.4363323129985824F, -0.40142572795869574F, -0.4363323129985824F);
		...
		this.setRotateAngle(this.rCheekFur, 0.17453292519943295F, -0.22689280275926282F, 0.3141592653589793F);
		...
		this.setRotateAngle(this.lWing01, 0.40142572795869574F, 0.41887902047863906F, 0.0F);
		...
		this.setRotateAngle(this.rWing01, 0.40142572795869574F, -0.41887902047863906F, 0.0F);
		this.bipedRightLeg = new ModelRenderer(this, 0, 16);
		this.bipedRightLeg.mirror = true;
		this.bipedRightLeg.setRotationPoint(-2.1F, 10.5F, 0.2F);
		this.bipedRightLeg.addBox(-1.5F, 0.0F, -2.0F, 3, 6, 4, 0.0F);
		this.setRotateAngle(this.bipedRightLeg, -0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tailFur02R, 0.0F, -0.12217304763960307F, 0.0F);
		...
		this.setRotateAngle(this.lEar03, 0.0F, 0.0F, 0.17453292519943295F);
		...
		this.setRotateAngle(this.lWing03, 0.6283185307179586F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rLegFur, -0.10471975511965977F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn01a, 0.0F, 0.0F, -0.22689280275926282F);
		...
		this.setRotateAngle(this.tail05, 0.2792526803190927F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn01a, 0.0F, 0.0F, 0.22689280275926282F);
		...
		this.setRotateAngle(this.lEar01, -0.4363323129985824F, 0.40142572795869574F, 0.4363323129985824F);
		...
		this.setRotateAngle(this.lCheekFur, 0.17453292519943295F, 0.22689280275926282F, -0.3141592653589793F);
		...
		this.setRotateAngle(this.rEar03, 0.0F, 0.0F, -0.17453292519943295F);
		...
		this.setRotateAngle(this.rLeg02, 0.6108652381980153F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing04, 0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lLeg03, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lEar02, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWingMembrane, -0.15707963267948966F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rEar02, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedLeftLeg, -0.2617993877991494F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tailFur01, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail03, 0.22689280275926282F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn02, -0.13962634015954636F, 0.0F, 0.10471975511965977F);
		...
		this.setRotateAngle(this.lLeg02, 0.6108652381980153F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWingMembrane, -0.15707963267948966F, 0.0F, 0.0F);
