...
/**
 * lilith - cybercat5555 Created using Tabula 5.1.0
 */
public class ModelLilith extends ModelBase {
	...
	public ModelLilith() {
		...
		this.setRotateAngle(this.rWing02, 0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing04, 0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHair01, 0.3665191429188092F, 0.0F, 0.22689280275926282F);
		...
		this.setRotateAngle(this.rHorn04a, 0.0F, 0.0F, 0.3141592653589793F);
		...
		this.setRotateAngle(this.rEarb, 0.0F, 0.0F, 0.22689280275926282F);
		...
		this.setRotateAngle(this.rWing05c, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn03a, 0.0F, 0.0F, 0.3665191429188092F);
		...
		this.setRotateAngle(this.skirtF, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.boobs, -0.593411945678072F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing03, 0.4363323129985824F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing05b, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn02, 0.0F, 0.0F, -0.5235987755982988F);
		...
		this.setRotateAngle(this.bipedRightLeg, -0.3141592653589793F, 0.0F, 0.10471975511965977F);
		...
		this.setRotateAngle(this.mhair02, 0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing01, 0.10471975511965977F, 0.0F, -0.13962634015954636F);
		...
		this.setRotateAngle(this.lWing05, 0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lEarb, 0.0F, 0.0F, -0.22689280275926282F);
		this.bipedLeftLeg = new ModelRenderer(this, 0, 16);
		this.bipedLeftLeg.setRotationPoint(1.7F, 1.7F, -0.2F);
		this.bipedLeftLeg.addBox(-2.0F, -1.0F, -2.5F, 4, 10, 5, 0.0F);
		this.setRotateAngle(this.bipedLeftLeg, -0.3141592653589793F, 0.0F, -0.10471975511965977F);
		...
		this.setRotateAngle(this.lSkirt, -0.22689280275926282F, 0.0F, -0.06981317007977318F);
		...
		this.setRotateAngle(this.rHorn01, 0.0F, 0.0F, 0.6632251157578453F);
		...
		this.setRotateAngle(this.lWing01, 0.10471975511965977F, 0.0F, 0.13962634015954636F);
		...
		this.setRotateAngle(this.rHoof, 0.03490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lowerJaw, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rWing05, 0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lArm02, -0.3665191429188092F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lLeg03, -0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn03a, 0.0F, 0.0F, -0.3665191429188092F);
		...
		this.setRotateAngle(this.lEara, -0.13962634015954636F, -0.6981317007977318F, 0.6981317007977318F);
		...
		this.setRotateAngle(this.rClaw, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing03, 0.4363323129985824F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedLeftArm, 0.10471975511965977F, 0.0F, -0.10000736613927509F);
		...
		this.setRotateAngle(this.lHoof, 0.03490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.mhair01, 0.5235987755982988F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lHorn01, 0.0F, 0.0F, -0.6632251157578453F);
		...
		this.setRotateAngle(this.lWing04, 0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedRightArm, 0.10471975511965977F, 0.0F, 0.10000736613927509F);
		...
		this.setRotateAngle(this.lHorn05, 0.0F, 0.0F, -0.22689280275926282F);
		...
		this.setRotateAngle(this.rSkirt, -0.22689280275926282F, 0.0F, 0.06981317007977318F);
		...
		this.setRotateAngle(this.lHorn04a, 0.0F, 0.0F, -0.3141592653589793F);
		...
		this.setRotateAngle(this.rHorn05, 0.0F, 0.0F, 0.22689280275926282F);
		...
		this.setRotateAngle(this.lHair01, 0.3665191429188092F, 0.0F, -0.22689280275926282F);
		...
		this.setRotateAngle(this.rLeg03, -0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rHorn02, 0.0F, 0.0F, 0.5235987755982988F);
		...
		this.setRotateAngle(this.lWing05b, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing05c, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rLeg02, 0.6981317007977318F, 0.0F, -0.10471975511965977F);
		...
		this.setRotateAngle(this.lLeg02, 0.6981317007977318F, 0.0F, 0.10471975511965977F);
		...
		this.setRotateAngle(this.rEara, -0.13962634015954636F, 0.6981317007977318F, -0.6981317007977318F);
		...
		this.setRotateAngle(this.lClaw, -0.3490658503988659F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.nose, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lWing02, 0.41887902047863906F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.rArm02, -0.3665191429188092F, 0.0F, 0.0F);
