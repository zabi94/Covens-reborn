...
public enum ModCrops {
	ACONITUM(Blocks.FARMLAND, 20), ASPHODEL(Blocks.FARMLAND), BELLADONNA(Blocks.FARMLAND, 20), GINGER(Blocks.FARMLAND), KELP(Blocks.WATER), MINT(Blocks.FARMLAND, 0), WHITE_SAGE(Blocks.FARMLAND), MANDRAKE(Blocks.FARMLAND, 20), LAVENDER(Blocks.FARMLAND, 0), THISTLE(Blocks.FARMLAND, 0), TULSI(Blocks.FARMLAND), KENAF(Blocks.FARMLAND), GARLIC(Blocks.FARMLAND, 0), WORMWOOD(Blocks.FARMLAND, 20), HELLEBORE(Blocks.FARMLAND, 20), SAGEBRUSH(Blocks.FARMLAND), INFESTED_WHEAT(ModBlocks.infested_farmland), CHRYSANTHEMUM(Blocks.FARMLAND);
