...
public final class LibMod {
	...
	// Dependency
	public static final String DEPENDENCIES = "required-after:forge@[14.23.4.2796,);" + "required-after:patchouli@[1.0-6,);" + "after:jei@[4.9.1.168,);" + "after:waila@[1.8.24-B39_1.12,);" + "required-after:baubles@[1.5.2,);" + "after:thaumcraft@[6.1.BETA26,);";
