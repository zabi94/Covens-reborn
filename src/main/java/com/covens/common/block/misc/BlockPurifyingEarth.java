...
public class BlockPurifyingEarth extends BlockMod {
	...
	public void onEntityWalk(World worldIn, BlockPos pos, Entity entityIn) {
		...
		if (attr == EnumCreatureAttribute.UNDEAD || attr == CovensAPI.getAPI().DEMON || attr == CovensAPI.getAPI().SPIRIT || transformation == DefaultTransformations.VAMPIRE || transformation == DefaultTransformations.SPECTRE || transformation == DefaultTransformations.WEREWOLF) {
