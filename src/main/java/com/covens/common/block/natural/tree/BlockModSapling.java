...
public class BlockModSapling extends BlockBush implements IGrowable, IModelRegister {
	...
	public BlockModSapling(String id) {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(STAGE, 0).withProperty(TYPE, EnumSaplingType.ELDER));
	}
	...
	private static void generateJuniperTree(World world, BlockPos pos, Random r) {
		...
		IBlockState log = ModBlocks.log_juniper.getDefaultState().withProperty(BlockLog.LOG_AXIS, EnumAxis.NONE);
