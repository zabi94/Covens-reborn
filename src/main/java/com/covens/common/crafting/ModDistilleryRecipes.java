...
public class ModDistilleryRecipes {
	...
	public static void init() {
		...
		REGISTRY.register(DistilleryRecipe.Factory.start("emanation_of_dishonesty").withBaseProcessingTime(300).withInput(LibIngredients.graveyardDust, LibIngredients.blazeRod, LibIngredients.fumeBottledMagic).withOutput(new ItemStack(ModItems.emanation_of_dishonesty)).build());
		REGISTRY.register(DistilleryRecipe.Factory.start("otherworldy_tears").withBaseProcessingTime(300).withInput(LibIngredients.enderPearl, LibIngredients.lapis, LibIngredients.fumeBirchSoul, LibIngredients.sagebrush).withOutput(new ItemStack(ModItems.otherworld_tears), new ItemStack(ModItems.dimensional_sand, 2, 0)).build());
